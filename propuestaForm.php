...
<html lang="es">
  <head>
    <title>Crear propuesta - aprUEnde</title>
  ...
  <body>
    ...
    <div class="jumbotron text-center bg-dark rounded-0" style="margin-bottom:0">
      <img src="img/logoEE.png" class="mainLogo" alt="Logo">
    </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          ...
          <div class="formProp" > 
            ...
            <form method="post" action="propuestaFormSent.php">

              <div class="form-group">
                <label for="namePropForm">Nombre de la propuesta:</label>
                <input class="form-control" id="namePropForm" name="namePropForm" placeholder="" required>
              </div>

              <div class="form-group">
                <label for="descPropForm">Descripción</label>
                <textarea class="form-control" id="descPropForm" name="descPropForm" placeholder="">
                </textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="facultPropForm" name="facultPropForm">
