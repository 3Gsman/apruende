...
<html lang="es">
  <head>
    <title>Propuestas - aprUEnde</title>
        ...
        <div class="col-12 col-md-8">
          ...
          <div id="mainProp" class="divPropuestas">	
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="btnAdd">
                  <button onclick="location.href='propuestaForm.php'" type="button" class="btn btn-outline-dark">Añadir propuesta</button>
                </div>
              </div>
            </div>
          </div>

          <?php include('php/propuestadb.php'); ?>
