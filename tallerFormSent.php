...
<html lang="es">
  <head>
    <title>Taller enviado - aprUEnde</title>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="btnAdd">
                <button onclick="location.href='talleres.php'" type="button" class="btn btn-outline-dark">Todos los talleres</button>
              </div>
            </div>
          </div>
          ...
          <div class="propSent">
            ...
            <p>Nombre: <?php echo $_POST["nameTalForm"]; ?></p>
            <p>Descripcion: <?php echo $_POST["descTalForm"]; ?></p>
            <p>Facultad: <?php echo $_POST["facultTalForm"]; ?></p>
            ...
            $nameTalForm = stripslashes($_REQUEST['nameTalForm']);
            $nameTalForm = mysqli_real_escape_string($con,$nameTalForm); 
            $descTalForm = stripslashes($_REQUEST['descTalForm']);
            $descTalForm = mysqli_real_escape_string($con,$descTalForm);
            $facultTalForm = stripslashes($_REQUEST['facultTalForm']);
            $facultTalForm = mysqli_real_escape_string($con,$facultTalForm);

            $IDOwn = 1;
            $Active = 1;

            $query = "INSERT into `Taller` (IDUsTal, NombreTal, DescripcionTal, FacultadTal, ActiveTal) VALUES ('$currentID','$nameTalForm', '$descTalForm', '$facultTalForm', '$Active')";
			...
			<h4>Se ha enviado correctamente.</h4></div>";          
              ...
              echo "<div class='verifPropForm'>
			<h4>No ha podido ser enviado. Se ha producido un error.</h4></div>";  
            }
