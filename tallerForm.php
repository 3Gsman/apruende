...
<html lang="es">
  <head>
    <title>Crear taller - aprUEnde</title>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="btnAdd">
                <button onclick="location.href='talleres.php'" type="button" class="btn btn-outline-dark">Atras</button>
              </div>
            </div>
          </div>
          ...
          <div class="formProp" > 
            ...
            <form method="post" action="tallerFormSent.php">

              <div class="form-group">
                <label for="nameTalForm">Nombre del taller:</label>
                <input class="form-control" id="nameTalForm" name="nameTalForm" placeholder="" required>
              </div>

              <div class="form-group">
                <label for="descTalForm">Descripción</label>
                <textarea class="form-control" id="descTalForm" name="descTalForm" placeholder="">
                </textarea>
              </div>

              <div class="form-group">

                <label for="facultPropForm">Facultad:</label>
                <select class="form-control" id="facultTalForm" name="facultTalForm">
